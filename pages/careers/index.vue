            ...
            <div class="md:max-w-7xl pt-16 md:pt-24 justify-center w-[100%] md:px-4 mx-auto">
                <div class="md:flex justify-between md:space-x-6">
                    ...
                    <div class="block md:hidden bg-gray-100 p-5 flex justify-between space-x-3">
                        <Search />
                        <button class="flex items-center justify-center space-x-3 bg-blue-500 rounded shadow px-2 text-white">
                            <span>Filters</span>
                    ...
                    <div class="w-full md:w-[73%] h-screen pb-[200px] overflow-y-auto">
                        <div class="md:flex justify-between md:space-x-5">
                            <div class="w-full md:w-[65%] bg-white md:rounded-xl md:border border-gray-300">
                                <div class="grid md:grid-cols-1 md:gap-4 px-2">
                                    <div v-for="i in 12" :key="i"
                                        class="border-b cursor-pointer rounded p-5 hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
