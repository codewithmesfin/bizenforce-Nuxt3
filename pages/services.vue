<template>
  <div>
    <Head>
      ...
      <Meta
        name="description"
        content="To help the world connect to opportunity and positively impact business"
      />
    </Head>
    ...
    <section class="bg-black bg2 py-32 md:py-10">
      <div class="md:max-w-[60%] px-5 md:pt-12 mx-auto md:px-2 sm:px-6 lg:px-8">
        <div>
          <h2 class="text-lg text-gray-100 font-semibold py-2 text-center">
            Our Services
          </h2>
          <h2
            class="text-3xl text-center font-extrabold text-white md:text-6xl py-3"
          >
            To help the world connect to opportunity and positively impact
            business.
          </h2>
          <p
            class="text-md md:text-lg text-center font-normal text-white mx-auto py-3"
          >
            We’re on a mission to help you connect to opportunity and positively
            impact business. We'll be sharing stories, insights, and resources
            to help you make the most of your work and make a difference in the
            world. We're excited to get started, and we hope you are too. Let's
            ...
            <div class="md:flex md:items-center md:space-x-10">
              <div class="md:w-1/2">
                <img
                  :src="item.img"
                  alt=""
                  class="w-32 md:w-full md:min-w-72 h-32 md:h-72 mx-auto"
                />
              </div>
              <div class="md:w-1/2">
                <h1
                  class="font-extrabold text-center md:text-left text-xl md:text-4xl py-3"
                >
                  {{ item.title }}
                </h1>
...
const services = [
  ...
  {
    img: "https://img.freepik.com/free-vector/desktop-smartphone-app-development_23-2148683810.jpg?w=1380&t=st=1670049276~exp=1670049876~hmac=e2c63f8235fa6499db2eeb4e5dbc6c7611290bf021ffbc8e2d2d28d591a73a63",
