<template>
  <div>
    <Head>
      <Title
        >Bizenforce - The Honest And Reliable Tech Partner Working For Your
        Success</Title
      >
      <Meta
        name="description"
        content="If you are striving for success, we are your best partner. We are a small team of Software Engineers. After working in some of the highest Tech Industries in USA, and United Kingdom, we realized that our experience, technical skills, and our Tech values can be put to create technologies that will transform lives"
      />
    </Head>
    ...
    <section>
      <div class="md:flex md:ml-auto w-full items-center md:max-w-[94%] pt-16">
        <main
          class="mx-auto max-w-[100%] xs:w-[100%] md:w-[50%] px-4 md:pt-16 pt-8 md:pr-16"
        >
          <div class="sm:text-center lg:text-left">
            <h1
              class="text-4xl font-sans md:text-7xl font-extrabold text-center md:text-left capitalize"
            >
              <span class="text-gray-900"> The best partner </span>
              <span class="text-blue-600 py-1"> You must have ®</span>
            </h1>
            <p
              class="py-4 text-gray-600 text-center md:text-left text-lg md:text-xl"
            >
              If you are striving for success, we are your best partner. We are
              a small team of Software Engineers. After working in some of the
              highest Tech Industries in USA, and United Kingdom, we realized
              that our experience, technical skills, and our Tech values can be
              put to create technologies that will transform lives.
        ...
        <div
          class="xs:w-[100%] hidden md:block md:w-[50%] lg:inset-y-0 lg:right-0 lg:w-1/2"
        >
          <img
            class="h-56 md:w-full object-cover sm:h-72 md:h-96 lg:w-full min-h-[550px]"
    ...
    <section class="py-12 w-full">
      <h1 class="text-center text-xl font-sans font-semibold">
        We can help you integrate 1000+ Seamless APIs
      </h1>
      <div
        class="hidden md:max-w-7xl md:flex justify-center w-[100%] py-4 px-4 mt-6 mx-auto"
      >
       <div class="flex flex-wrap space-x-10 space-y-10 items-center justify-center">
    ...
    <section>
      <div class="md:max-w-7xl justify-center w-[100%] py-4 px-4 mt-6 mx-auto">
        <div class="md:max-w-[80%] mx-auto">
          <h1
            class="text-2xl font-sans md:text-6xl font-extrabold text-center capitalize"
          >
            <!-- The First and Only Real-Time Search Engine for B2B Sales Leads -->
            The Honest and reliable tech partner working for your success.
          </h1>
          <p class="py-4 text-center text-gray-600 text-lg md:text-xl">
            Our vision is to enable vibrant technologies amidst a world
            dominated by few giants. As our first step in this grand journey we
            are engineering the rails on which our partners' business flows
            because we believe that a real-time, simple to use, responsive to
            customer's need platform will act as a catalyst to unlock business
      ...
      <div class="md:max-w-7xl justify-center w-[100%] py-4 px-4 pt-12 mx-auto">
        <div class="md:flex md:space-x-10">
          <div class="w-full md:w-1/2">
            <h2 class="font-semibold text-blue-500 py-3">
              GET A BETTER SOLUTION
            </h2>
            <h1 class="text-xl md:text-5xl py-2 font-extrabold capitalize">
              We are working hard to delivery quality service
            </h1>
            <p class="py-2 text-lg">
              The team at BizEnfore is busy to for delivering high quality
              product and service and their continuous improvement within the
    ...
    <section class="bg-[#edf2f7] pt-6 pb-12">
      <div class="md:max-w-7xl justify-center w-[100%] py-4 px-4 mt-6 mx-auto">
        <div class="md:max-w-[70%] mx-auto">
          ...
          <p class="py-4 text-center text-gray-600 text-lg md:text-xl">
            Let us know the problems in your business, we will setup a
            discussion session, once we clearly understand your business rules
            and problems , we will come up with an affordable software
            solution...
            <NuxtLink class="text-blue-600" to="/services">Learn More</NuxtLink>
          </p>
        </div>
        <div class="md:flex md:justify-evenly">
          <div
            class="md:w-[30%] my-3 shadow bg-white border border-gray-200 p-10 cursor-pointer"
          >
            <h1 class="text-center text-[#2196f3] text-6xl font-extrabold">
              1
            </h1>
            <h1 class="text-center text-[#2196f3] text-xl font-semibold">
          ...
          >
            ...
            <h1 class="text-center text-black text-xl font-semibold">
              Let us create the right solution
            </h1>
          </div>
          <div
            class="md:w-[30%] my-3 shadow bg-white border border-gray-200 p-10 cursor-pointer"
          >
            ...
            <h1 class="text-center text-blue-500 text-xl font-semibold">
...
const serviceList = [
  {
    ...
    desc: "Let us discuss on your ideas and rise it to your dream success",
  },
  {
    img: "https://kinsta.com/de/wp-content/uploads/sites/5/2019/11/woocommerce-crm-1024x512.png",
    title: "System Developer",
    desc: "We can transform your ideas into a problem solving systems. You will proud of us.",
  },
  {
    ...
    desc: "Our teams work hard to help your business is ranked high online",
  },
  {
    ...
    title: "Integraions",
    desc: "We can integrate your business with 1000+ renowned APIs and systems",
  },
];
</script>
