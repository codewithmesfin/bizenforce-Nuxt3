<template>
    <div class="w-full md:w-[40%]">
        <div class="md:shadow-lg rounded p-5 md:p-10  md:border border-gray-100">
            <div class="mb-5">
                <h1 class="text-4xl md:4xl font-bold text-center md:text-left">Let us know how can we support you!</h1>
            </div>
            <div class="py-2">
                ...
                <input type="text" id="full_name"
                    ...
                    placeholder="Mesfin Tsegaye" required>
            </div>
            <div class="py-2">
                ...
                <input type="email" id="email"
                    class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-0 focus:outline-none block w-full p-2.5 "
                    placeholder="sciemesfin55@gmail.com" required>
            </div>
            ...
            <div class="py-2">
                ...
                <input type="phone" id="phone"
                    class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-0 focus:outline-none block w-full p-2.5 "
                    placeholder="+251911522902" required>
            </div>
            ...
            <div class="py-2">
                    ...
                    <div
                        ...
                        <div class="py-2 px-4 bg-white rounded-t-lg dark:bg-gray-800">
                            ...
                            <textarea id="comment" rows="6"
                                class="px-0 w-full text-sm text-gray-900 bg-white border-0 dark:bg-gray-800 focus:ring-0 focus:outline-none dark:text-white dark:placeholder-gray-400"
                                placeholder="Write a your message..." required></textarea>
                        </div>
                ...
                <p class="ml-auto text-xs text-gray-500 dark:text-gray-400">Remember, contributions
                    to this topic should follow our <a href="#"
